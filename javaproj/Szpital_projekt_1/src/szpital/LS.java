...
public class LS {
	...
	public boolean ask_del(){
		System.out.println("Odpinanie specjalnoœci od lekarzy, lista:");
		System.out.println(this);
		do {
			System.out.println("Podaj identyfikator wpisu do usuniêcia (<0 - przerwanie):");
